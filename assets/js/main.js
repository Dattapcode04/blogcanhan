...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const cards = document.querySelectorAll('.blog-card, .project-card, .resource-card, .certificate-card');
...
resourceCards.forEach(card => {
    card.addEventListener('click', function(e) {
        ...
        if (url && url !== '#' && url !== 'https://example.com/books' && 
            url !== 'https://example.com/music' && url !== 'https://example.com/mindfulness' && 
...
const blogCards = document.querySelectorAll('.blog-card:not(.certificate-card)');
...
const certificateCardsForEffects = document.querySelectorAll('.certificate-card');
